 ...
 * **`custom_uri_scheme`**: Custom deep link URI scheme of the built application.         The application can be started using with such browser links that use this scheme.
