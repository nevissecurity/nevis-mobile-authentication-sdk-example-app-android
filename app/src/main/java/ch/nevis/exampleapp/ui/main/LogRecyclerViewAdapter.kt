...
/**
 * An implementation of [RecyclerView.Adapter] abstract class that renders [LogItem] objects into
 * recycler items.
 *
...
class LogRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: LogViewHolder, position: Int) {
        ...
        log[position].let { logItem: LogItem ->
            ...
            holder.messageTextView.text = context.getString(
                R.string.log_item,
                dateFormatter.format(logItem.date),
                logItem.message
            )
        }
    }
